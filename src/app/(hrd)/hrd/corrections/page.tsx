...
export default async function HrdCorrectionsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Persetujuan Koreksi Absensi</h1>
        <p className="text-slate-500 mt-1">
          Kelola pengajuan perbaikan data absensi karyawan
        </p>
      </div>
      <CorrectionApprovals
